...
{	
	...
	/**
	 * Entfernt eine Authority aus der einen Liste und f�gt sie in die andere ein.
	 * 
	 * @param authorityName - der Name der zu wechselnden Authority
	 * @param fromList - die Liste aus der die Authority zu l�schen ist
	 * @param toList - die Liste in die die Authority einzuf�gen ist 
