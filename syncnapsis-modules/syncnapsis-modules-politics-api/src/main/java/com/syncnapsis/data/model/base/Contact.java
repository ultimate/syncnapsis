...
/**
 * Abstrakte Klasse als generische Grundlage f�r die Beziehungen zwischen:
 * - Allianz & Allianz
 * - Allianz & Imperium
 * - Imperium & Allianz
 * - Imperium & Imperium
 * �ber die Kontaktzuordnung werden beiden Parteien Kontakt-Rechte zugeordnet.
 * Desweiteren bietet diese Klasse die M�glichkeit den derzeitigen Zustand der
 * Best�tigung beider Parteien zu erfassen, sowie �nderungen vorzuschlagen und
 * diese erneut zu best�tigen.
 * 
 * @author ultimate
 * @param <C1> - die Klasse f�r die eine Seite der Kontaktzuordnung
 * @param <C2> - die Klasse f�r die andere Seite der Kontaktzuordnung
 * @param <R> - die Klasse f�r die Rechte, die vergeben werden
 */
@MappedSuperclass
...
{
	/**
	 * Ist diese Kontaktzuordnung grunds�tzlich gleichberechtigt f�r beide
	...
	/**
	 * Ein m�glicher �nderungsvorschlag f�r die Rechte der 1. Partei
	 */
	private A		changedContactAuthorities1;
	/**
	 * Wurde die Zuordnung von der 1. Partei best�tigt?
	 */
	private boolean	approvedByContact1;
	/**
	 * Wurden die gemachten �nderungen von der 1. Partei best�tigt?
	 */
	...
	/**
	 * Ein m�glicher �nderungsvorschlag f�r die Rechte der 2. Partei
	 */
	private A		changedContactAuthorities2;
	/**
	 * Wurde die Zuordnung von der 2. Partei best�tigt?
	 */
	private boolean	approvedByContact2;
	/**
	 * Wurden die gemachten �nderungen von der 2. Partei best�tigt?
	 */
