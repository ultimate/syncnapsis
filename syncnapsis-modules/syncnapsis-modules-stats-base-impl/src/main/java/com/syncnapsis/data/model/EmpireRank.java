...
/**
 * Rang-Objekt f�r die Bewertung von Imperien auf Basis von GenericRank.
 * 
 * @author ultimate
 */
@Entity
...
{
	// TODO anzahl kolonien und anzahl bl�cke
	
	/**
	 * Die Punktbewertung der wirtschaftlichen St�rke des Imperiums
	 */
	@RankCriterion
	private int economy;

	/**
	 * Die Punktbewertung der milit�rischen St�rke des Imperiums
	 */
	@RankCriterion
	private int military;

	/**
	 * Die Punktbewertung der wissenschaftlichen St�rke des Imperiums
	 */
	@RankCriterion
	private int science;
