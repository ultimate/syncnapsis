 ...
 * Diese Klasse definiert Posten bzw. R�nge innerhalb einer Allianz. �ber diese
 * R�nge sind Imperien der Allianz zugeordnet. Der Spieler, dem das zugeordnete
 * Imperium geh�rt bekleidet diesen Rang und verf�gt �ber die dem Rang
 * zugeordneten Rechte f�r die Verwaltung bzw. F�hrung der Allianz. Die R�nge
 * einer Allianz bilden eine hierarchische Struktur ab, in dem jedem Rang ein
 * �bergeordneter Rang zugewiesen werden kann. So ist gew�hrleistet, dass
 * m�gliche Bef�rderungen nur innerhalb von Teilhierarchien erlaubt sind und
 * eine F�hrungstruktur f�r die Allianz aufgebaut werden kann.
 * 
 * @author ultimate
 */
@Entity
...
{
	/**
	 * Der Name des Ranges. Es sind hier auch Platzhalter m�glich um einen
	 * sprachabh�ngigen Namen verwenden zu k�nnen.
	 */
	private String						rankName;
	/**
	 * Ist dieser Rang f�r Nicht-Mitglieder sichtbar?
	 */
	...
	/**
	 * Die Allianz, zu der dieser Rang geh�rt.
	 */
	...
	/**
	 * Die Liste aller R�nge, denen dieser Rang als �bergeordneter Rang
	 * zugeordnet ist.
	 */
