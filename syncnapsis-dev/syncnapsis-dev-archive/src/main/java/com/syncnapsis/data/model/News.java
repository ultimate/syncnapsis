 ...
 * f�r alle Benutzer/Spieler sichtbar. Damit die Nachrichten in mehreren
 * Sprachen erfasst werden k�nnen gibt es zus�tzlich zur ID eine NewsID, welche
 * unter alle sprachvarianten einer Nachricht gleich ist, um deren
 * Zusammengeh�rigkeit zu definieren.
 * 
 * @author ultimate
 */
@Entity
...
{
	/**
	 * Die NewsID f�r die Definition der Zusammengeh�rigkeit mehrere
	 ...
	 * Wichtigere Nachrichten werden nach ihrem Erscheinen noch l�nger
	 * angezeigt.
	 */
	...
	/**
	 * Ist die Nachricht von hoher Priorit�t (z.B. Server-Shutdown)
	 */
