...
/**
 * Model-Klasse "Fenster-Parameter f�r die GUI"
 * Wenn ein neues Fenster erzeugt wird und f�r die aufgerufene GUIAction eine
 * GUIWindowParams-Objekt existiert, so werden die in dieser Klasse gesetzten
 * Attribute an das Fenster �bergeben. Alle hier definierten Attribute sind an
