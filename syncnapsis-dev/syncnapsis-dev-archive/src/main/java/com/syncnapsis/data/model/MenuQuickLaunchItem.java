...
/**
 * Model-Klasse "Schnellstart-Men�-Eintrag"
 * Die Klasse repr�sentiert eine Verkn�pfung zwischen MenuItem und Benutzer um
 * festzulegen, an welcher Stelle und mit welchen ggf. notwendigen Parametern
 * ein Men�-Eintrag zus�tzlich auch im Schnellstart-Men� angezeigt wird.
 * 
 * @author ultimate
 */
@Entity
...
{
	/**
	 * Der Benutzer f�r den das Schnellstart-Men� gilt
	 */
	private User		user;
	/**
	 * Der Men�-Eintrag, der angezeigt werden soll
	 */
	private MenuItem	menuItem;
	/**
	 * Position des Men�-Eintrags im Schnellstart-Men�
	 */
	private int			position;
	/**
	 * Ggf. notwendiger Parameter-Wert f�r die Action des Menu-Eintrags
	 */
	 ...
	 * Der Men�-Eintrag, der angezeigt werden soll
	 * 
	 * @param menuItem - der Men�-Eintrag
	 */
	...
	/**
	 * Wert des ggf. notwendigen Parameters zur �bergabe an die GUIAction als
	 * Long geparst
	 * 
