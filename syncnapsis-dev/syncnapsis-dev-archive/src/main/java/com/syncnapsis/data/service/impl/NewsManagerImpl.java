...
/**
 * Manager-Implementierung f�r den Zugriff auf News.
 * 
 * @author ultimate
 */
...
{
	/**
	 * NewsDao f�r den Datenbankzugriff
	 */
	protected NewsDao			newsDao;
	/**
	 * ParameterManager f�r den Datenbankzugriff
	 */
	 ...
	 * 
	 * @param dao - NewsDao f�r den Datenbankzugriff
	 * @param parameterDao - ParameterDao f�r den Datenbankzugriff
	 */
