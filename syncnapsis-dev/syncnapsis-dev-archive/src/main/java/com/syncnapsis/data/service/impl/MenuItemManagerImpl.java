...
/**
 * Manager-Implementierung f�r den Zugriff auf MenuItem.
 * 
 * @author ultimate
 */
public class MenuItemManagerImpl extends GenericManagerImpl<MenuItem, String> implements MenuItemManager
{
	...
	/**
	 * MenuItemDao f�r den Datenbankzugriff
	 */
	 ...
	 * 
	 * @param menuItemDao - MenuItemDao f�r den Datenbankzugriff
	...
	/**
	 * Setzt eine Liste aus MenuItemOptionHandler-Klassen f�r die Behandlung der Erstellung von
	 * Submen�s
	 * 
	 * @param optionHandlerClasses - die Liste der Klassen
	 * @throws ClassNotFoundException - wenn die Klasse ung�ltig ist
	 */
