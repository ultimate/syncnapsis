...
/**
 * Provider-Klasse f�r das statische Abrufen von Texten anhand von Schl�sseln
...
public class LabelProvider extends ParameterizedProvider<String, String>
{
	...
	/**
	 * Gibt den Text zum gegebenen Schl�ssel zur�ck.
	 * Falls der Schl�ssel nicht existiert, wird ???key??? zur�ckgegeben.
	 * 
	 ...
	 * Gibt den Text zum gegebenen Schl�ssel zur�ck.
	 * Falls der Schl�ssel nicht existiert, wird ???key??? zur�ckgegeben.
	 * In der Nachricht werden zus�tzlich Platzhalter durch die Argumente in
	 * args ersetzt.
	 * 
	 * @see org.zkoss.util.resource.impl.LabelLoader#getLabel(String)
	 * @param key - der Schl�ssel
	...
	/**
	 * Gibt den Text zum gegebenen Schl�ssel zur�ck.
	 * Falls der Schl�ssel nicht existiert, wird defValue zur�ckgegeben.
	 * 
	 * @see org.zkoss.util.resource.impl.LabelLoader#getLabel(String)
	 * @param key - der Schl�ssel
