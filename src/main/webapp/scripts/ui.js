...
UI.LABEL_ID_PLAYERNAME = "bar_top_playername";
...
UI.init = function()
{
	...
	UI.layout_bar_bottom = new Styles.FillLayout([ "bar_bottom_left", "bar_bottom_center", "bar_bottom_right" ], [ UI.constants.BAR_OUTER_WIDTH, null, UI.constants.BAR_OUTER_WIDTH ],
...
UI.onLogin = function(player)
{
	...
	document.getElementById(UI.LABEL_ID_PLAYERNAME).innerHTML = player.user.username;
	// change language to users selection
	Locale.select(player.user.locale);
