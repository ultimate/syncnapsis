...
//	 * A linear distribution (increasing)
//	 */
//	public static final Distribution	LINEAR_INCREASING	= new Distribution() {
//																/*
//																 * (non-Javadoc)
//																 * @see com.syncnapsis.utils.math.
//																 * Distribution#probability(double)
...
//																{
//																	double d = UNIFORM.next(random);
//																	return Math.signum(d) * Math.sqrt(2 * Math.abs(d));
//																}
//															};
//
//	/**
//	 * A linear distribution (decreasing)
//	 */
//	public static final Distribution	LINEAR_DECREASING	= new Distribution() {
//																/*
//																 * (non-Javadoc)
//																 * @see com.syncnapsis.utils.math.
//																 * Distribution#probability(double)
...
//																{
//																	double d = UNIFORM.next(random);
//																	return Math.signum(d) * Math.sqrt(2 * (1 - Math.abs(d)));
//																}
//															};
//
//	/**
//	 * A square distribution (increasing)
//	 */
//	public static final Distribution	SQUARE_INCREASING	= new Distribution() {
//																/*
//																 * (non-Javadoc)
//																 * @see com.syncnapsis.utils.math.
//																 * Distribution#probability(double)
...
//	 * A square distribution (decreasing)
//	 */
//	public static final Distribution	SQUARE_DECREASING	= new Distribution() {
//																/*
//																 * (non-Javadoc)
//																 * @see com.syncnapsis.utils.math.
//																 * Distribution#probability(double)
...
//	 * @author ultimate
//	 */
//	public static final Distribution	CUBIC_INCREASING	= new Distribution() {
//																/*
//																 * (non-Javadoc)
//																 * @see com.syncnapsis.utils.math.
//																 * Distribution#probability(double)
...
//	 * A cubic distribution (decreasing)
//	 */
//	public static final Distribution	CUBIC_DECREASING	= new Distribution() {
//																/*
//																 * (non-Javadoc)
//																 * @see com.syncnapsis.utils.math.
//																 * Distribution#probability(double)
