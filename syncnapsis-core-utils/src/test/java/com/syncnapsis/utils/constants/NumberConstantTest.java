 ...
 * @author ultimate
 */
@TestCoversClasses({ Constant.class, NumberConstant.class })
public class NumberConstantTest extends LoggerTestCase
{
	@TestCoversMethods({ "define", "defineNull", "as*", "raw", "getName" })
	public void testDefine()
	{
		String name = "a name";
		NumberConstant c = new NumberConstant(name);
