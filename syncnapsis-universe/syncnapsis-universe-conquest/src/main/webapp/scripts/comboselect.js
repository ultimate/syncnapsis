...
ComboSelect = function(sourceElement, targetElement)
{
	...
	this.sourceElement.classList.add("comboselect");
	this.sourceElement.classList.add("source");
	this.targetElement.classList.add("comboselect");
	...
	this.unhighlight = function() {
		for(var i = 0; i < this.sourceElement.children.length; i++)
			this.sourceElement.children[i].classList.remove("active");
		for(var i = 0; i < this.targetElement.children.length; i++)
			this.targetElement.children[i].classList.remove("active");
	};
