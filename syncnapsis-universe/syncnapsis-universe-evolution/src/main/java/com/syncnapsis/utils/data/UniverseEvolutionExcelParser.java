...
public class UniverseEvolutionExcelParser
{
	 ...
	 * daraus Testdaten.
	 * 
	 * @param properties - die Einstellungen f�r das Erstellen der Testdaten
	 */
	...
	/**
	 * Laden der Spalten f�r die Kontakt-Rechte
	 * 
	 * @param workbook - das Workbook
	 * @param key_sheet_authorities_c - der Key f�r das Sheet
	 */
	public static void parseContactAuthorities(HSSFWorkbook workbook, String key_sheet_authorities_c)
	{
		...
		// sheet_authorities_c -> Laden der Spalten f�r die Kontakt-Rechte
	...
	/**
	 * Laden der Spalten f�r die Allianz-Rechte
	 * 
	 * @param workbook - das Workbook
	 * @param key_sheet_authorities_a - der Key f�r das Sheet
	 */
	public static void parseAllianceAuthorities(HSSFWorkbook workbook, String key_sheet_authorities_a)
	{
		...
		// sheet_authorities_a -> Laden der Spalten f�r die Allianz-Rechte
	 ...
	 * 
	 * @param workbook - das Workbook
	 * @param key_sheet_players - der Key f�r das Sheet
	 */
	 ...
	 * 
	 * @param workbook - das Workbook
	 * @param key_sheet_empires - der Key f�r das Sheet
	 */
	 ...
	 * 
	 * @param workbook - das Workbook
	 * @param key_sheet_allianceMemberships - der Key f�r das Sheet
	 */
	public static void parseAlliancesMemberships(HSSFWorkbook workbook, String key_sheet_allianceMemberships)
	{
		...
		while((cell = sheet_allianceMemberships.getRow(0).getCell(colNum++)) != null)
		{
			try
			{
				...
				// Mitglieder den R�ngen zuweisen
				rowNum = 1;
	 ...
	 * 
	 * @param workbook - das Workbook
	 * @param key_sheet_diplomacy_aa - der Key f�r das Sheet
	 */
	 ...
	 * 
	 * @param workbook - das Workbook
	 * @param key_sheet_diplomacy_ae - der Key f�r das Sheet
	 */
	 ...
	 * 
	 * @param workbook - das Workbook
	 * @param key_sheet_diplomacy_ee - der Key f�r das Sheet
	 */
