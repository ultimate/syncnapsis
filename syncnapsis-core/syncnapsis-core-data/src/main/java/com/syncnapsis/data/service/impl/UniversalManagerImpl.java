...
/**
 * Universelle Manager-Implementierung f�r den Zugriff auf beliebige Klassen
 * 
 * @author ultimate
 */
@Transactional
public class UniversalManagerImpl implements UniversalManager
{
	...
	/**
	 * UniversalDao f�r den Datenbankzugriff.
	 */
	 ...
	 * 
	 * @param universalDao - UniversalDao f�r den Datenbankzugriff
	 */
