...
public abstract class DataGenerator implements InitializingBean
{
	...
	public void generateData()
	{
		...
		try
		{
			...
			// Backup der zu ver�ndernden Tabellen
			...
			// Leeren der zu ver�ndernden Tabellen
			...
			if("1".equals(testDataProperties.getProperty("dummyData.on")))
			{
				...
				// Exportieren der ver�nderten Tabellen mit Dbunit
			...
			// Wiederherstellung der ver�nderten Tabellen
