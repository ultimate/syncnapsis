...
public interface PlayerManager extends GenericManager<Player, Long>
{
	...
	/**
	 * F�gt eine Sittingverbindung zwischen zwei Benutzern hinzu.
	 * 
	...
	/**
	 * L�scht eine Sittingverbindung zwischen zwei Benutzern.
	 * 
	 * @param playerSittedId - der gesittete Benutzer
	 * @param playerSitterId - der sittende Benutzer
	 * @return der gesittete Benutzer
	...
	/**
	 * Pr�ft, ob ein Sitter noch freie Pl�tze f�r Gesittete hat oder nicht
	 * 
	 * @param player - der
	...
	/**
	 * Pr�ft, ob ein Gesitteter noch freie Pl�tze f�r Sitter hat oder nicht
	 * 
	 * @param player - der
	 * @return true oder false
	 */
