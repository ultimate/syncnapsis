 ...
 * Relation zwischen User und Messenger, die die Messenger-Adresse/ID enth�lt.
 * 
 * @author ultimate
 */
@Entity
...
public class MessengerContact extends BaseObject<Long> implements Ownable<User>
{
	...
	/**
	 * Der Benutzer zu dem die Adresse/ID geh�rt
	 */
	protected User		user;
	/**
	 * Der Messenger zu dem die Adresse/ID geh�rt
	 */
