 ...
 * Diese Klasse repr�sentiert die Kontakt-/Freundschaftszuordnung zwischen 2
...
{
	/**
	 * Der 1. Benutzer f�r die Kontakt-/Freundschaftszuordnung
	 */
	protected User	user1;
	/**
	 * Der 2. Benutzer f�r die Kontakt-/Freundschaftszuordnung
	 */
	protected User	user2;
	/**
	 * Hat der 1. Benutzer die Kontakt-/Freundschaftszuordnung best�tigt?
	 */
	protected boolean	approvedByUser1;
	/**
	 * Hat der 2. Benutzer die Kontakt-/Freundschaftszuordnung best�tigt?
	 */
	...
	/**
	 * Gibt den anderen Benutzer zur�ck
	 * 
	...
	/**
	 * Pr�ft, ob der andere Benutzer die Kontakt-/Freundschaftszuordnung
	 * best�tigt hat
	 * 
	...
	/**
	 * Pr�ft, ob der gegebene Benutzer die Kontakt-/Freundschaftszuordnung
	 * best�tigt hat
	 * 
	 * @param user - einer der beiden Benutzer
