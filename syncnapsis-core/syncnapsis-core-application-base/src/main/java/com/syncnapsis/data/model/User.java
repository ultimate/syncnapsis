 ...
 * Um am Spiel teilzunehmen muss man sich als Benutzer f�r die Anwendung
 * registrieren. �ber die dem Benutzerkonto zugewiesene Benutzerrolle werden
 * dann alle Zugriffsrechte, sowie Beschr�nkungen in der Anwendung geregelt.
 * Dar�ber hinaus enth�lt das User-Objekt die meisten wichtigen oder unwichtigen
 * Informationen �ber den Benutzer (wie z.B. Spitzname, Beschreibung,
...
public class User extends ActivatableInstance<Long>
{
	/**
	 * Benutzername:
	 * Dieser Name muss einmalig ohne Ber�cksichtigung der Gro�- und
	 * Kleinschreibung sein!
	 */
	protected String					username;
	/**
	 * E-Mail-Adresse:
	 * Muss einmalig sein. Kann i.d.R. nicht ge�ndert werden.
	 */
	protected String					email;

	/**
	 * Passwort (wird verschl�sselt in der DB gespeichert)
	 */
	...
	/**
	 * Spieleinstellung: Werden erweiterte Men�s verwendet?
	 */
	protected boolean					usingAdvancedMenu;
	/**
	 * Spieleinstellung: Sollen spielerkl�rende Tooltips gezeigt werden?
	 */
	...
	/**
	 * Tempor�re zusammengesetzte Liste aus userContacts1 & userContacts2
	 */
	...
	/**
	 * Datum, zu dem die Benutzerrolle f�r diesen Benutzer abl�uft
	 ...
	 * Passwort (wird verschl�sselt in der DB gespeichert)
	 * 
	 * @param password - das Passwort (verschl�sselt)
	 */
