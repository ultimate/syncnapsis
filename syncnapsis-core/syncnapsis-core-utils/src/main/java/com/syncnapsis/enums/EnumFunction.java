...
/**
 * Enum f�r die Spezifizierung und Verwendung von Funktionen. Die Funktion
 * werden f�r die Modellierung bzw. Berechnung von Verl�ufen benutzt.
 * F�r die Berechnung der Verl�ufe kann sowohl der Funktionswert selbst, als
...
public enum EnumFunction
{
	...
	/**
	 * Berechnet den Funktionswert an der Stelle param mit zus�tzlichen default
	 * Parametern.
	 * 
	 ...
	 * 
	 * @param param - die Stelle, an der der Funktionswert berechnet werden soll
	 * @param softness - wenn die Funktion softness unterst�tz, gibt dieser
