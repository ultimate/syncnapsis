...
/**
 * Hilfsklasse um nachtr�glich Ressourcen dem Classpath hinzuzuf�gen
 */
public abstract class ClassPathUtil
{
	...
	/**
	 * Hilfsvariable f�r URLClassLoader.class.getDeclaredMethod("addURL", parameters);
	 */
	@SuppressWarnings("rawtypes")
	private static final Class[]	parameters	= new Class[] { URL.class };

	/**
	 * F�ge eine Datei per Pfad zum Classpath hinzu
	 * 
	 * @param file - der Dateipfad
	 * @throws IOException - wenn die Datei nicht existiert oder der Dateiname ung�ltig ist
	 */
	...
	/**
	 * F�ge eine Datei per File zum Classpath hinzu
	 * 
	...
	/**
	 * F�ge eine Ressource per URL zum Classpath hinzu
	 * 
	 * @param u - die Ressource als URL
	 * @throws IOException - wenn die Ressource nicht existiert oder ung�ltig ist
	 */
