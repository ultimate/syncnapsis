...
/**
 * Util-Klasse, die einen vereinfachten Zugriff auf die von Java zur Verf�gung gestellten TimeZones
 * erm�glicht. Dazu werden die in TimeZone vorhanden Zeitzonen nach Regionen aufgegliedert (Teil vor
 * dem '/'). Auf diese Weise ist sp�ter an der Oberfl�che f�r den Benutzer eine differenzierte
 * Auswahl seiner Zeitzone m�glich.
 * 
 * @author ultimate
 */
public abstract class TimeZoneUtil
{
	...
	/**
	 * Map, die zu jeder Region die darin enthalten IDs enth�lt.
	 * Die Map wird einmalig initialisiert um sp�ter schneller abrufbar zu sein.
	 */
	private static TreeMap<String, List<String>>	sortedIds;
	/**
	 * Die Liste aller Regionen.
	 * Die Liste wird einmalig initialisiert um sp�ter schneller abrufbar zu sein.
	 */
	...
	/**
	 * Gibt eine Zeitzone zur gegebene timeZoneId zur�ck.
	...
	/**
	 * Gibt eine Zeitzone zur gegebene Region und ID zur�ck.
	 * Kurzform f�r getTimeZone(region + "/" + id)
	 * 
	...
	/**
	 * Gibt alle IDs zu einer Region zur�ck, die in der Map gespeichert sind.
	 * 
	 * @param region - die Region
	 * @return die Liste (unmodifizierbar)
	 */
	...
	/**
	 * Initialisiert die Liste der Regionen und die Map der IDs f�r die weitere Benutzung.
	 * Es werden daf�r alle verf�gbaren timeZondIds aus TimeZone analysiert. Der Teil der timeZoneId
