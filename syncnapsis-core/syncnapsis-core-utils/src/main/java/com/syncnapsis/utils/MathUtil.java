...
/**
 * Util-Klasse f�r die Berechnung mathematischer Formeln und Funktionen
 * 
 * @author ultimate
 */
...
{
	/**
	 * Normale Schrittgr��e f�r die Approximation einer Bezierkurve
	 */
	private static double	stepSize		= 0.05;
	/**
	 * Feinere Schrittgr��e f�r die Approximation einer Bezierkurve
	 */
	 ...
	 * und p2 definiert. �ber das Array nearest kann der n�chste Punkt n zum Punkt p auf der Geraden
	 * zur�ckgegeben werden (Schnittpunkt aus Lot und Linie). Der zur�ckgegeben Abstand entspricht
	 * dem Abstand des Punkte p zum Punkt n. Bei der Berechnung des Abstands wird dabei die Linie
	 * als endlich betrachtet. Liegt der Schnittpunkt des Lotes mit der Linie au�erhalb der Linie,
	 * so ist einer der Endpunkt der n�chste Punkt n zu p.
	 * 
	 ...
	 * @param nearest - ein Array f�r die R�ckgabe des n�chsten Punktes auf der Linie
	...
	/**
	 * Berechnet den Abstand eines Punktes p zu einem Shape und den n�chsten Punkt n auf dem Shape.
	 * Es werden dazu alle Teilst�cke des Shapes gepr�ft und der geringste Abstand ermittelt. Bei
	 * den Teilst�cken kann es sich um Linien oder Bezierkurven handeln. Es kann der n�chste Punkt
	 * n, sowie der Winkel und Abstand zu diesem Punkt in Arrays zur�ckgegeben werden.
	 * 
	 ...
	 * @param x - die x-Koordinate des zu untersuchenden Punkts
	 * @param y - die y-Koordinate des zu untersuchenden Punkts
	 * @param nearest - der n�chste Punkt n zum Punkt p auf dem Shape
	...
	/**
	 * Berechnet den Abstand eines Punktes p zu einer Bezierkurve und den n�chsten Punkt n auf der
	 * Kurve. Dazu wird die Bezierkurve numerisch approximiert und in definierten Schrittabst�nden
	 * berechnet. Es kann der n�chste Punkt n, sowie der Winkel und Abstand zu diesem Punkt in
	 * Arrays zur�ckgegeben werden.
	 * 
	 ...
	 *            Kurve im Punkt n
	 * @param highPrecision - soll die Bezierkurve mit feinerer Schrittgr��e approximiert werden?
	 * @return der Abstand des Punktes p zum Shape bzw. zum Punkt n
	 */
