...
/**
 * Hilfs-Klasse f�r die Berechnung mathematischer Funktionen
 * 
 * @author ultimate
 */
...
{
	/**
	 * Mathematischen Funktion z.B. f�r die Verwendung als Gradient.
	 * Die Funktion ist symmetrisch: f(-param) = f(param)
	 * Die Funktion erf�llt die Bedingungen f(0) = 1; f(1) = 0
	 * Geradengleichung: f(param > 0) = 1 - param
	 * 
	 * @param param - der Parameter f�r die Funktion
	 ...
	 * 
	 * @param param - der Parameter f�r die Funktion
	 * @param softness - wie gro� soll das Kreissegment sein?
	 * @return der Funktionswert
	 */
	 ...
	 * Mathematischen Funktion z.B. f�r die Verwendung als Gradient.
	 * Die Funktion ist symmetrisch: f(-param) = f(param)
	 * Die Funktion erf�llt die Bedingungen f(0) = 1; f(1) = 0 NICHT
	 * Geradengleichung mit "Kreissegment an der Spitze"
	 * 
	 * @param param - der Parameter f�r die Funktion
	 * @param softness - wie gro� soll das Kreissegment sein?
	 ...
	 * Mathematischen Funktion z.B. f�r die Verwendung als Gradient.
	 * Die Funktion ist symmetrisch: f(-param) = f(param)
	 * Die Funktion erf�llt die Bedingungen f(0) = r; f(r) = 0
	 ...
	 * Mathematischen Funktion z.B. f�r die Verwendung als Gradient.
	 * Die Funktion ist symmetrisch: f(-param) = f(param)
	 * Die Funktion erf�llt die Bedingungen: f(0) = ry; f(rx) = 0
	 ...
	 * Mathematischen Funktion z.B. f�r die Verwendung als Gradient.
	 * Die Funktion ist symmetrisch: f(-param) = f(param)
	 * Die Funktion erf�llt die Bedingungen f(0) = 1; f(1) = 0, wenn normalize = true
	 * Bei Normalisierung gilt f_norm = (f(x) - f(1)) / (f(0) - f(1))
	 * Gaussglocke mit sigma beliebig & mu = 0
	 * 
	 * @param param - der Parameter f�r die Funktion
	 * @param sigma - der Sigma-Wert f�r die Gaussglocke
	 ...
	 * Mathematischen Funktion z.B. f�r die Verwendung als Gradient.
	 * Die Funktion ist symmetrisch: f(-param) = f(param)
	 * Die Funktion erf�llt die Bedingungen f(1) = 0; f(0) = 1
	 * Modifizierte Gaussglocke mit beliebigen Werten f�r bound, gradient & sigma.
	 * param < bound
	 * f(param) = "Geringf�gig angepasste Gaussglocke, so dass f in bound stetig ist und f(0) = 1"
	 * param > bound
	 ...
	 * Mathematischen Funktion z.B. f�r die Verwendung als Gradient.
	 * Die Funktion ist symmetrisch: f(-param) = f(param)
	 * Die Funktion erf�llt die Bedingungen f(1) = 0; f(0) = discHeight
